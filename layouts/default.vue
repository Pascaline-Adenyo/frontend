<template>
  <div class="flex min-h-screen">
    <div
      ...
      class="fixed inset-0 transition-opacity duration-300 bg-black/50 backdrop-blur-sm lg:hidden z-40"
    ></div>
      ...
      <div class="flex items-center justify-between">
        ...
        >
          <div class="flex items-center justify-between w-full">
            <div class="flex items-center gap-3">
              ...
              <h3 class="nav-section-title">Clients</h3>
            </div>
        ...
        <transition name="slide-down">
          <div v-show="expandedSections.clients" class="mt-2 space-y-1">
            <router-link to="/ficheclient" class="nav-item nav-item-nested" :class="{ 'nav-item-active': $route.path === '/ficheclient' }">
              <div class="nav-icon">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="flex-1">
                <p class="nav-label">Fiches Clients</p>
                <p class="nav-description">Dossiers clients complets</p>
              </div>
            </router-link>

            <router-link to="/contactassocie" class="nav-item nav-item-nested" :class="{ 'nav-item-active': $route.path === '/contactassocie' }">
              <div class="nav-icon">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="flex-1">
                <p class="nav-label">Contacts Associés</p>
                <p class="nav-description">Interlocuteurs principaux</p>
              </div>
            </router-link>

            <router-link to="/historiquevente" class="nav-item nav-item-nested" :class="{ 'nav-item-active': $route.path === '/historiquevente' }">
              <div class="nav-icon">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="flex-1">
                <p class="nav-label">Historique Ventes</p>
                <p class="nav-description">Commandes et factures</p>
              </div>
            </router-link>

            <router-link to="/conditionpaiement" class="nav-item nav-item-nested" :class="{ 'nav-item-active': $route.path === '/conditionpaiement' }">
              <div class="nav-icon">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div class="flex-1">
                <p class="nav-label">Conditions Paiement</p>
                <p class="nav-description">Modalités et échéances</p>
              </div>
            </router-link>

            <router-link to="/recouvrement" class="nav-item nav-item-nested" :class="{ 'nav-item-active': $route.path === '/recouvrement' }">
              <div class="nav-icon">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                </svg>
              ...
              <div class="flex-1">
                <p class="nav-label">Recouvrement</p>
                <p class="nav-description">Suivi des impayés</p>
              </div>
            </router-link>
          </div>
        </transition>
              ...
              >
                <div class="flex items-center justify-between w-full">
                  <div class="flex items-center gap-3">
                    <div class="nav-icon">
                      <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2-2v16l3.5-2 3.5 2 3.5-2 3.5 2zM9 5h6v2H9V5zm0 4h6v2H9V9z"/>
                      </svg>
                    </div>
        ...
        >
          <div class="flex items-center justify-between w-full">
            <div class="flex items-center gap-3">
              ...
              <h3 class="nav-section-title">Fournisseurs</h3>
            </div>
        ...
        <div class="flex-shrink-0 px-4 py-4 border-t border-sky-700 bg-sky-900">
          <div class="flex items-center gap-3 p-3 rounded-xl bg-white/5 backdrop-blur-sm border border-white/10">
            ...
            <div class="flex-1 min-w-0">
              <p class="text-sm font-semibold text-white truncate">Ambroise ADENYO</p>
              <p class="text-xs text-sky-200 truncate">Administrateur</p>
            </div>
            <div class="flex-shrink-0">
              <button 
          ...
          <transition name="user-menu">
            <div
              v-if="showUserMenu"
              class="absolute bottom-20 left-4 right-4 z-50 py-2 bg-white rounded-xl shadow-2xl border border-gray-200 transform transition-all duration-200"
              @click.stop
            >
    ...
    <div class="flex flex-col flex-1 lg:ml-64">
      <header class="flex items-center justify-between h-16 px-6 bg-white border-b border-gray-200 shadow-sm sticky top-0 z-30">
        ...
        <div class="flex items-center space-x-4">
          <div class="relative hidden md:block">
            <input
              ...
              class="w-64 py-2 pl-10 pr-4 border border-gray-300 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500"
            />
          ...
          <button class="relative p-2 text-gray-400 hover:text-gray-600">
            <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.586V11a6 6 0 10-12 0v3.586c0 .53-.21 1.04-.595 1.414L4 17h5m6 0a3 3 0 11-6 0h6z"></path>
            </svg>
          ...
          <div class="relative">
            <button
              @click="showHeaderUserMenu = !showHeaderUserMenu"
              class="flex items-center p-2 space-x-2 rounded-lg hover:bg-gray-100"
            >
              <div class="w-8 h-8 bg-gradient-to-br from-sky-500 to-sky-600 rounded-full flex items-center justify-center">
                <span class="text-sm font-semibold text-white">AA</span>
              </div>
              <svg class="w-4 h-4 text-gray-400 transition-transform duration-200" :class="{ 'rotate-180': showHeaderUserMenu }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
              </svg>
            </button>
            ...
            <transition name="header-user-menu">
              <div
                ...
                class="absolute right-0 top-full mt-2 w-48 py-2 bg-white rounded-lg shadow-xl border border-gray-200 z-50"
                @click.stop
              >
      ...
      <!-- Zone de contenu principal avec un seul background -->
...
const pageTitle = computed(() => {
  const titleMap: Record<string, string> = {
    ...
    '/ficheclient': 'Gestion des Clients',
    '/recouvrement': 'Gestion des recouvrements',
    '/historiquevente': 'Historique des ventes',
    '/contactassocie': 'Gestion des contacts associés',
    '/conditionpaiement': 'Gestion des paiements',
  }
